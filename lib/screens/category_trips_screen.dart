...
class CategoryTripsScreen extends StatefulWidget {
  ...
  @override
  _CategoryTripsScreenState createState() =>
      _CategoryTripsScreenState();

}
 class _CategoryTripsScreenState extends
 State<CategoryTripsScreen>{
  ...
  void didChangeDependencies() {
    ...
    // this val return the filtered categories by catId from trips_data
