...
const Trips_data = const [
  Trip(
    ...
    program: [
      ' هتستلم الغرف فى الفندق وتستريح شويه من تعب السفر .',
      'و بليل بعد ما تستريح تروح تسهر أحلى سهرة بدوى.',
      'عبارة عن تنورة و أغانى بدوى وقعدة وسط الجبل على أضواء الشموع والنجوم، ده غير الليزر اللي هتشوفه أشكال وألوان علي الجبل ، وممكن تزود عشاء بدوي كمان فى قعدتكا.',
      ' ( تانى احسن مكان فى العالم للغطس )'
      ' أجمل وأغرب الأسماك اللي ممكن تشوفها وسط الشعب المرجانية.',
      ' اللي بيحب المغامرة لازم يزور أبو جالوم ، و دي محمية طبيعية بتوصل لها باللنش من البلوهول هتستمتع فيها بالعوم و السنوركلينج .',
    ],
    isInSummer: false,
    isForFamilies: true,
    isInWinter: true,
